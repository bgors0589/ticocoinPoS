...
---------------------
	...
	git clone https://github.com/ticocoin/ticocoin
	cd ticocoin
...
This will build Ticocoin-Qt as well if the dependencies are met.
...
Note: Currently, there is no ticocoin ebuild available in overlay 
...
Notes
-----
The release is built with GCC and then "strip ticocoind" to strip the debug
