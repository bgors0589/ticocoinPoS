...
unsigned int nProtocolV03SwitchTime     = 1635205354;
unsigned int nProtocolV03TestSwitchTime = 1635205364;
// Protocol switch time of v0.4 kernel protocol
unsigned int nProtocolV04SwitchTime     = 1635205380;
unsigned int nProtocolV04TestSwitchTime = 1635205440;
// Protocol switch time of v0.5 kernel protocol
unsigned int nProtocolV05SwitchTime     = 1635205480;
unsigned int nProtocolV05TestSwitchTime = 1635205510;
// Protocol switch time of v0.6 kernel protocol
// supermajority hardfork: actual fork will happen later than switch time
const unsigned int nProtocolV06SwitchTime     = 1635205545; //
const unsigned int nProtocolV06TestSwitchTime = 1635205620; //
