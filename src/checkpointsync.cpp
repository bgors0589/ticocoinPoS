...
// tgccoin: sync-checkpoint master key
...
// tgccoin: synchronized checkpoint (centrally broadcasted)
...
// tgccoin: get last synchronized checkpoint
...
// tgccoin: only descendant of current sync-checkpoint is allowed
...
// tgccoin: reset synchronized checkpoint to last hardened checkpoint
...
// tgccoin: find block wanted by given orphan block
...
// tgccoin: verify signature of sync-checkpoint message
...
// tgccoin: process synchronized checkpoint
...
// get information of sync-checkpoint (first introduced in tgccoin)
